...
var isMapLoadingForFirstTime = true;
...
function DrawGoogleMap() {
    var mylatlng = new google.maps.LatLng(22.193353, 79.009552);
    var myOptions = {
        zoom: 4,
        center: mylatlng,
    ...
    google.maps.event.addListenerOnce(map, 'idle', function () {
        ...
        if (isMapLoadingForFirstTime && typeof onMapLoadComplete != "undefined") {
            isMapLoadingForFirstTime = false;
            onMapLoadComplete();
        }
    });
